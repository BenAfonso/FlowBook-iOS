...
extension Event {
    static func create(dateStart ds: Date , dateEnd de: Date, titleEvent title: String, containsEvent contains: String, colorEvent color: String, forPromotion promo: Promotion, theAuthor author: User) -> Event? {
